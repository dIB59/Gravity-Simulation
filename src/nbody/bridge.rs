...
pub struct SimulationBridge {
    ...
    initial_bodies: Arc<RwLock<Vec<crate::nbody::core::Body>>>,
}
...
impl SimulationBridge {
    ...
    pub fn get_initial_bodies(&self) -> Vec<crate::nbody::core::Body> {
...
fn simulation_worker(
    ...
    _initial_bodies: Arc<RwLock<Vec<crate::nbody::core::Body>>>,
) {
